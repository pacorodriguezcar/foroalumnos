<?php
/**
 * Card_Options_Excerpt control. Handles data passing from args to JS.
 *
...
/**
 * Class Card_Options_Excerpt
 *
 * @package Solace\Customizer\Controls\React
 */
class Card_Options_Excerpt extends \WP_Customize_Control {
	/**
	 * Control type.
	 *
	 * @var string
	 */
	public $type = 'solace_card_options_excerpt_control';
	/**
