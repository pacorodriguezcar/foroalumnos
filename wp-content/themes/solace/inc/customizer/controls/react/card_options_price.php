<?php
/**
 * Card_Options_Price control. Handles data passing from args to JS.
 *
...
/**
 * Class Card_Options_Price
 *
 * @package Solace\Customizer\Controls\React
 */
class Card_Options_Price extends \WP_Customize_Control {
	/**
	 * Control type.
	 *
	 * @var string
	 */
	public $type = 'solace_card_options_price_control';
	/**
