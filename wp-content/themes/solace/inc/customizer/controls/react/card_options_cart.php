<?php
/**
 * Card_Options_Cart control. Handles data passing from args to JS.
 *
...
/**
 * Class Card_Options_Cart
 *
 * @package Solace\Customizer\Controls\React
 */
class Card_Options_Cart extends \WP_Customize_Control {
	/**
	 * Control type.
	 *
	 * @var string
	 */
	public $type = 'solace_card_options_cart_control';
	/**
