<?php
/**
 * Card_Options_Title control. Handles data passing from args to JS.
 *
...
/**
 * Class Card_Options_Title
 *
 * @package Solace\Customizer\Controls\React
 */
class Card_Options_Title extends \WP_Customize_Control {
	/**
	 * Control type.
	 *
	 * @var string
	 */
	public $type = 'solace_card_options_title_control';
	/**
