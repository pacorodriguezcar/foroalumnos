<?php
/**
 * Typeface_Title control. Handles data passing from args to JS.
 *
...
/**
 * Class Typeface_Title
 *
 * @package Solace\Customizer\Controls\React
 */
class Typeface_Title extends \WP_Customize_Control {
	/**
	 * Control type.
	 *
	 * @var string
	 */
	public $type = 'solace_typeface_title_control';
	/**
