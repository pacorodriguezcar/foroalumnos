 ...
 * @access public
 */
class Tabs_Custom extends \WP_Customize_Control {
	 ...
	 * @var   string
	 */
	public $type = 'interface-tabs-custom';
	...
	public function content_template() {
		...
		<div class="solace-tabs-custom-control" id="">
		<# var i = 1;
			for( tab in data.tabs) { #>
				...
				#>
			<div class="solace-customizer-tab <# if( i === 1 ){#> active <#}#>" data-tab="{{tab}}">
