...
class Rtl extends Base_Customizer {
	...
	protected function change_controls() {
		...
		$this->change_customizer_object( 'control', 'solace_navigation_layout', 'choices', $this->rtl_navigation_layout_choices() );

		$this->change_customizer_object( 'control', 'solace_top_bar_layout', 'choices', $this->rtl_top_bar_layout_choices() );

		$sidebar_layout_controls = array(
			'solace_default_sidebar_layout',
			'solace_blog_archive_sidebar_layout',
			'solace_single_post_sidebar_layout',
		);
		...
		if ( class_exists( 'WooCommerce', false ) ) {
			$sidebar_layout_controls = array_merge(
				...
				array(
					'solace_shop_archive_sidebar_layout',
