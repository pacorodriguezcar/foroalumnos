...
use Solace\Customizer\Controls\Tabs;
...
class Manager {
	...
	public function load( $group = null, \WP_Customize_Manager $customize_manager = null ) {
		...
		foreach ( $this->get_settings_group( $group ) as $id ) {
			...
			if ( isset( $arguments['live_refresh_css_prop'] ) && isset( $arguments['live_refresh_css_prop']['cssVar'] ) && solace_is_new_skin() ) {
