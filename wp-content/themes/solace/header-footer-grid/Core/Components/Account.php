 ...
 */
class Account extends Abstract_Component {
	use Theme_Info;

	const COMPONENT_ID      = 'header_account';
	...
	const USE_GRAVATAR = 'header_account_use_gravatar';
	...
	public function toggle_style() {
		$css = '.hfg_header .sol-account-element a {
			display: flex;
			align-items: center;
			color: var(--color);
		}
		.hfg_header .sol-account-element a:hover {
			color: var(--hovercolor);
		}
		.hfg_header .sol-account-element .icon {
			display: flex;
			width: var(--iconsize);
			height: var(--iconsize);
		}
		.hfg_header .sol-account-element .label {
	...
	public function add_style( array $css_array = array() ) {
		...
		$css_array[] = [
			Dynamic_Selector::KEY_SELECTOR => '.builder-item--' . $this->get_id() . ' .hfg_header .sol-account-element a.sol-account-url span.icon',
			Dynamic_Selector::KEY_RULES    => [
		...
		$css_array[] = [
			Dynamic_Selector::KEY_SELECTOR => '.builder-item--' . $this->get_id() . ' .hfg_header .sol-account-element a.sol-account-url',
			Dynamic_Selector::KEY_RULES    => [
		...
		$css_array[] = [
			Dynamic_Selector::KEY_SELECTOR => '.builder-item--' . $this->get_id() . ' .hfg_header .sol-account-element a.sol-account-url:hover',
			Dynamic_Selector::KEY_RULES    => [
				Config::CSS_PROP_FILL_COLOR => [
					Dynamic_Selector::META_KEY     => $this->get_id() . '_' . self::HOVER_COLOR_ID,
					Dynamic_Selector::META_DEFAULT => SettingsManager::get_instance()->get_default( $this->get_id() . '_' . self::HOVER_COLOR_ID ),
	...
	public function render_component() {
		Main::get_instance()->load( 'components/component-account' );
	}
