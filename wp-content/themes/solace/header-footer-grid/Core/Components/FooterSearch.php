<?php
/**
 * FooterSearch Component class for Header Footer Grid.
 *
 ...
 */
class FooterSearch extends Abstract_Component {

	const COMPONENT_ID        = 'footer_search';
	const PLACEHOLDER_ID      = 'footer_search_placeholder';
	...
	/**
	 * FooterSearch constructor.
	 *
	 * @since   1.0.0
	 * @access  public
	 */
	public function init() {
		$this->set_property( 'label', __( 'Search Form', 'solace' ) );
		$this->set_property( 'id', $this->get_class_const( 'COMPONENT_ID' ) );
		$this->set_property( 'component_slug', 'hfg-footer-search-form' );
	...
	public function render_component() {
		...
		Main::get_instance()->load( 'components/component-search-footer' );
	...
	public function change_placeholder( $placeholder ) {
		return get_theme_mod( $this->get_id() . '_placeholder', __( 'Search for...', 'solace' ) );
	}
}
