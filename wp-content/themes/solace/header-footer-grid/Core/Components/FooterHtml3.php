 ...
 */
class FooterHtml3 extends Abstract_Component {
	const CONTENT_ID   = 'footer_content3';
	const COMPONENT_ID = 'footer_html3';
	const COLOR_ID     = 'color3';

	/**
	 * FooterHtml3 constructor.
	 *
	 * @since   1.0.0
	 * @access  public
	 */
	public function init() {
		$this->set_property( 'label', __( 'HTML Three', 'solace' ) );
	...
	public function toggle_style() {
		$css = '.builder-item .item--inner.builder-item--footer_html3,
		.builder-item .item--inner.builder-item--footer_html3 h1,
		.builder-item .item--inner.builder-item--footer_html3 h2,
		.builder-item .item--inner.builder-item--footer_html3 h3,
		.builder-item .item--inner.builder-item--footer_html3 h4,
		.builder-item .item--inner.builder-item--footer_html3 h5,
		.builder-item .item--inner.builder-item--footer_html3 h6 {
			color: var(--footer-text-color-html3);
		}';
	...
	public function add_settings() {
		SettingsManager::get_instance()->add(
			[
				...
				'default'            => '<div class="widget-area">
				<div id="solace-nav-menu-services" class="widget widget_nav_menu"><h5>Services</h5><div class="menu-footer-two-container"><ul id="menu-footer-two" class="menu"><li id="menu-item-528" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-528"><a href="#">E-commerce</a></li>
	...
	public function render_component() {
		Main::get_instance()->load( 'components/component-footer-html3' );
	}
}
