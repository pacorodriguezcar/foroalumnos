 ...
 */
class FooterButton2 extends Abstract_Component
{

	const COMPONENT_ID = 'button_base4';
	...
	const BUTTON_FONT_SIZE     = 'button_font_size_style_setting4';	
	...
	{
		$this->set_property('label', __('Button Two', 'solace'));
		$this->set_property('id', $this->get_class_const('COMPONENT_ID'));
		$this->set_property('component_slug', 'hfg-footer-button2');
		$this->set_property('width', 2);
		$this->set_property('section', 'footer_button2');
	...
	public function toggle_style()
	{
		...
		$css           = '.site-footer .builder-item--button_base4 { justify-content: var(--justify) !important; }';
		if (
			...
			$css = '.header .builder-item [class*="button_base4"] .button {box-shadow: var(--primarybtnshadow, none);} .header .builder-item [class*="button_base4"] .button:hover {box-shadow: var(--primarybtnhovershadow, none);}';
		}

		$css .= '.builder-item--button_base4 .component-wrap .button {font-size: var(--header-btn-font-size4);}';		
		$css .= '.builder-item--button_base4 .component-wrap .button {font-family: var(--buttonfontfamily);}';
	...
	{
		Main::get_instance()->load( 'components/component-button-footer2' );
	}
}
