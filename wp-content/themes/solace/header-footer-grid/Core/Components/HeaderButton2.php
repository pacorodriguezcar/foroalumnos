 ...
 */
class HeaderButton2 extends Abstract_Component
{

	const COMPONENT_ID = 'button_base2';
	...
	const BUTTON_FONT_SIZE     = 'button_font_size_style_setting2';
	...
	public function init()
	{
		...
		$this->set_property('component_slug', 'hfg-button2');
		$this->set_property('width', 2);
		$this->set_property('section', 'header_button2');
	...
	public function toggle_style()
	{
		...
		if (
			...
			$css = '.header .builder-item [class*="button_base2"] .button {box-shadow: var(--primarybtnshadow, none);} .header .builder-item [class*="button_base2"] .button:hover {box-shadow: var(--primarybtnhovershadow, none);}';
		}

		$css .= '.builder-item--button_base2 .component-wrap .button {font-size: var(--header-btn-font-size2);}';
		$css .= '.builder-item--button_base2 .component-wrap .button {font-family: var(--buttonfontfamily);}';
	...
	{
		Main::get_instance()->load('components/component-header-button2');
	}
}
