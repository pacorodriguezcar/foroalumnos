 ...
 */
class CopyrightHtml extends Abstract_Component {
	const CONTENT_ID   = 'copyright_content';
	const COMPONENT_ID = 'copyright_html';
	const COLOR_ID     = 'color';

	/**
	 * CopyrightHtml constructor.
	 *
	 * @since   1.0.0
	 * @access  public
	 */
	public function init() {
		$this->set_property( 'label', __( 'Copyright', 'solace' ) );
		$this->set_property( 'id', $this->get_class_const( 'COMPONENT_ID' ) );
		$this->set_property( 'width', 3 );
		$this->set_property( 'component_slug', 'hfg-copyright' );
	...
	public function add_settings() {
		SettingsManager::get_instance()->add(
			[
				...
				'default'            => __('Copyright © 2025 Solace WP. All rights reserved', 'solace'),
				'label'              => __( 'Copyright', 'solace' ),
