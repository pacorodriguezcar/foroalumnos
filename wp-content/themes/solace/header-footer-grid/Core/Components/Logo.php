...
class Logo extends Abstract_Component {
	...
	public function init() {
		...
		$this->set_property( 'description', __( 'Display your company logo here or simply use words to describe your business.', 'solace' ) );
	...
	public function add_settings() {
		...
		SettingsManager::get_instance()->add(
			[
				...
				'default'           => '{ "mobile": "170", "tablet": "170", "desktop": "170" }',
		...
		// 		'sanitize_callback'  => 'absint',
		// 		'default'            => false,
		// 		'label'              => __( 'Disable Homepage Link', 'solace' ),
		// 		'type'               => 'solace_toggle_control',
		// 		'section'            => $this->section,
		// 		'conditional_header' => true,
		// 	]
		...
		$css_array[] = [
			...
			Dynamic_Selector::KEY_RULES    => [
				'--maxwidth' => [
					...
					Dynamic_Selector::META_DEFAULT       => '{ "mobile": "170", "tablet": "170", "desktop": "170" }',
				],
				'--color'    => [
