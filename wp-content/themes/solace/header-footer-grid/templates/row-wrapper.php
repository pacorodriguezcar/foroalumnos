...
<div class="<?php echo esc_attr( join( ' ', $row_classes ) ); ?> footer-solace--row"
	data-row-id="<?php echo esc_attr( $row_index ); ?>" data-show-on="<?php echo esc_attr( $device ); ?>">

	<div
		class="footer-solace--row-inner my-row-inner footer-solace-<?php echo esc_attr( $row_index ); ?>-inner">
		<div class="container">
			<div
