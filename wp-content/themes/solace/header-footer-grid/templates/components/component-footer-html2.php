...
use HFG\Core\Components\FooterHtml2;

$content           = component_setting( FooterHtml2::CONTENT_ID );
$content           = apply_filters( 'solace_translate_single_string', $content, FooterHtml2::CONTENT_ID );
