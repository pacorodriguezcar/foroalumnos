...
use HFG\Core\Components\HeaderHtml1;

$content           = component_setting( HeaderHtml1::CONTENT_ID );
$content           = apply_filters( 'solace_translate_single_string', $content, HeaderHtml1::CONTENT_ID );
