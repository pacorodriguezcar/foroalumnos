			...
			<div class="textwidget">
				...
				echo sprintf(
					...
					sprintf(
						...
						__( 'Replace this widget content by going to %s and add widgets into this widget area.', 'solace' ), //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
						sprintf(
							/* translators: %1$s - link %2$s - name %3$s - label */
							'<a href="%1$s"><strong>%2$s  %3$s</strong></a>',
							esc_url( admin_url( 'customize.php?autofocus[section]=sidebar-widgets-header-' . $_id ) ),
							/* translators: %1$s - &rarr; symbol %2$s - &rarr; symbol %3$s - &rarr; symbol */
							sprintf( __( 'Appearance %1$s Customize %2$s Header %3$s', 'solace' ), '&rarr;', '&rarr;', '&rarr;' ), //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
