...
use HFG\Core\Components\LogoFooter;

$_id = current_component( FooterBuilder::BUILDER_NAME )->get_id();

$show_name     = component_setting( LogoFooter::SHOW_TITLE );
// $show_desc     = component_setting( LogoFooter::SHOW_TAGLINE );
$is_not_link   = component_setting( LogoFooter::DISABLE_LINK, false );
$display_order = component_setting( LogoFooter::DISPLAY, 'default' );
$main_logo     = get_theme_mod( 'custom_logo' );
$custom_logo   = component_setting( LogoFooter::CUSTOM_LOGO, $main_logo );

$active_logo      = $_id === 'logo' ? $main_logo : $custom_logo;
$conditional_logo = json_decode( component_setting( LogoFooter::LOGO, LogoFooter::sanitize_logo_json( $active_logo ) ), true );
