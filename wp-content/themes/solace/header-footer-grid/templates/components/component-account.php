...
use HFG\Core\Components\Account;

$icon_type   = component_setting( Account::TOGGLE_ICON_ID );
$icon_custom = component_setting( Account::TOGGLE_CUSTOM_ID, '' );
$svg_icon    = solace_kses_svg( Account::get_icon( $icon_type, $icon_custom ) );
$label       = component_setting( Account::PLACEHOLDER_ID );
$user_gravatar = component_setting( Account::USE_GRAVATAR );
