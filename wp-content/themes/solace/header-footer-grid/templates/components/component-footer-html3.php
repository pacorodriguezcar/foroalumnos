...
use HFG\Core\Components\FooterHtml3;

$content           = component_setting( FooterHtml3::CONTENT_ID );
$content           = apply_filters( 'solace_translate_single_string', $content, FooterHtml3::CONTENT_ID );
