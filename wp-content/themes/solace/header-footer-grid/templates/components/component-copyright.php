...
use HFG\Core\Components\CopyrightHtml;

$content           = component_setting( CopyrightHtml::CONTENT_ID );
$content           = apply_filters( 'solace_translate_single_string', $content, CopyrightHtml::CONTENT_ID );
