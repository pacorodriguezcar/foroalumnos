...
class Members extends WP_List_Table {
    ...
    function column_userid( $item ) {
        ...
        $deactivate   = wp_nonce_url(
                admin_url( sprintf( 'admin.php?page=wpforo-members&wpfaction=%1$s&userid=%2$s', 'user_deactivate', $item['userid'] ) ),
                'wpforo-user-deactivate-' . $item['userid']
        );
        ...
        $actions      = [
                ...
                'ban'          => '<a href="' . esc_url( (string) $ban ) . '" style="color: orange;" title="' . __( 'Ban', 'wpforo' ) . '" onclick="return confirm(\'' . __(
                                'Are you sure, you want to BAN this user?',
                                'wpforo'
                        ) . '\')">' . __( 'Ban', 'wpforo' ) . '</a>',
                'unban'        => '<a href="' . esc_url( (string) $unban ) . '" style="color: orange;" title="' . __( 'Unban', 'wpforo' ) . '" onclick="return confirm(\'' . __(
                                'Are you sure, you want to UNBAN this user?',
                                'wpforo'
                        ) . '\')">' . __( 'Unban', 'wpforo' ) . '</a>',
                'activate'     => '<a href="' . esc_url( (string) $activate ) . '" style="color: green;" title="' . __( 'Activate', 'wpforo' ) . '" onclick="return confirm(\'' . __(
                                'Are you sure, you want to activate this user?',
                                'wpforo'
                        ) . '\')">' . __( 'Activate', 'wpforo' ) . '</a>',
                'deactivate'   => '<a href="' . esc_url( (string) $deactivate ) . '" style="color: #8a5700;" title="' . __( 'Deactivate', 'wpforo' ) . '" onclick="return confirm(\'' . __(
                                'Are you sure, you want to deactivate this user?',
                                'wpforo'
                        ) . '\')">' . __( 'Deactivate', 'wpforo' ) . '</a>',
